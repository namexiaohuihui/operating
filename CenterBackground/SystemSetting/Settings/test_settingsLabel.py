...
@Software:  PyCharm
@file:      test_settingsLabel.py
@time:      2018/12/20 15:57
@desc:
"""
import os
import inspect
...
class TestSettingsLabel(unittest.TestCase):
    """
    城市tab切换用例所在地
    """
    # 定义头部button中，后面N位不需要
    ...
    def test_pseudo_code(self):
        col_cdoe = self.system_p._visible_return_selectop(".col-sm-6.col-xs-12")
        assert col_cdoe, "伪代码判断出错"
