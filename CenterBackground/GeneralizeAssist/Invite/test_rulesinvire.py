...
config = GeneralizeAssist.add_key(GeneralizeAssist.invite, GeneralizeAssist.rules)
i_jude = InviteOperateJude(config, basename, Generalize)


class TestRulesinvire(unittest.TestCase):
    """
       invite页面中明细跳转
       """
