...
class TestInviteTabs(unittest.TestCase):
    """
    城市tab切换用例所在地
    """
    # 定义头部button中，后面N位不需要
    ...
    def setUpClass(cls):
        ...
        config = GeneralizeAssist.add_key(GeneralizeAssist.invite, GeneralizeAssist.tabs)
        cls.sw_tab = CommoditiesJude(config, cls.basename, Generalize)
