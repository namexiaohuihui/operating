...
config = GeneralizeAssist.add_key(GeneralizeAssist.invite, GeneralizeAssist.preview)
i_jude = InviteOperateJude(config, basename, Generalize)


class TestPreviewinvire(unittest.TestCase):
    """
       invite页面中用户跳转
       """
