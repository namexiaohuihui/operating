...
class TestSecKillScreen(unittest.TestCase):
    """
    条件筛选
    """
    ...
    def setUpClass(cls):
        ...
        config = GeneralizeAssist.add_key(GeneralizeAssist.secKill, GeneralizeAssist.select)
        cls.i_screen = SecKillLableVerify(config, cls.basename, Generalize)
