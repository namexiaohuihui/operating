...
class TestSingleSendView(unittest.TestCase):
    """
    通过筛选查看页面数据
    """
    ...
    def setUpClass(cls):
        ...
        config = InteractionActions.add_key(InteractionActions.single, InteractionActions.views)
