...
@Software:  PyCharm
@file:      test_bigorderssweating.py
@time:      2018/9/10 9:42
@desc:
"""
import os
...
from CenterBackground.MovementUser.Sweating.setSweating import BigordersSweating
...
release = BigordersSweating(config, basename, Consumers) # 重写了点击按钮


class TestBigordersSweating(unittest.TestCase):
    def setUp(self):
        # 获取运行文件的类名
